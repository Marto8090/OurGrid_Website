...
import PrivacyBg from "../assets/privacypage.png"; // <- your image
  ...
  return (
    <main className="min-h-screen bg-[#F9F5F2] flex flex-col">
      <section className="relative flex-1">
        {/* BACKGROUND IMAGE – uses your Dutch grid picture */}
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: `url(${PrivacyBg})` }}
        />
        {/* Subtle plum overlay for readability on top of the photo */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#4F2E39]/65 via-[#4F2E39]/25 to-[#F9F5F2]" />

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 space-y-6">
          {/* HEADER STRIP */}
          <div className="rounded-2xl bg-[#4F2E39] text-[#F9F5F2] px-4 py-3 sm:px-6 sm:py-4 shadow-md max-w-xl">
            <p className="text-xs sm:text-sm uppercase tracking-wide text-[#F4B14A]">
              Privacy & data use
            </p>
            ...
            <p className="text-xs sm:text-sm mt-1 opacity-90">
              How OurGrid and its partners handle information about website
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full text-left p-4 sm:p-5 flex flex-col focus:outline-none focus-visible:ring-2 focus-visible:ring-[#01AC51] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded-2xl"
                  >
                    <div className="flex items-start gap-3 w-full">
                      <div className="flex-1">
                        <p className="text-xs font-semibold uppercase tracking-wide text-[#4F2E39]">
                          Privacy
                        </p>
                      ...
                      <div className="flex flex-col items-end gap-1 ml-2">
                        ...
                        <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#F4B14A] text-[#4F2E39] shadow-sm">
                          {isOpen ? (
