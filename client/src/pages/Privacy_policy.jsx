      ...
      <section className="relative flex-1">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 space-y-6">
          ...
          {/* FIX APPLIED HERE: 
             ...
             This prevents the grid from stretching all items in a row 
             to the height of the tallest (expanded) item.
          */}
              ...
              return (
                ...
                >
                  <button
                    ...
                    // Removed 'h-full' from here to ensure button size reflects content size only
