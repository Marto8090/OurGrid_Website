              ...
              >
                ...
                <div
                  ...
                  className="
                    ...
                    pointer-events-none
                    /* Using -0.5px to ensure a visible 1px drop from your previous version */
                    -translate-y-[calc(28.6%-0.5px)] md:-translate-y-[28.6%]
                    z-20
                  "
                >
                  <svg className="w-[53.5%] h-[53.5%]" viewBox="0 0 120 120">
                    <circle
                      ref={ringRef}
                      cx="60"
                      cy="60"
              ...
              <div className="relative z-10 flex flex-row items-center justify-between gap-4">
                ...
                <div className="flex-shrink-0">
                   <img
                    src={Question}
                    alt="Question mark"
                    className="w-16 sm:w-20 md:w-32 lg:w-36 object-contain drop-shadow-2xl transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110"
                  />
                </div>
              </div>
              <div className="relative z-10 w-full">
                 <a
                  href={isMunicipality ? "/m/what-is-grid-congestion" : "/u/what-is-grid-congestion"}
                  className="w-full flex items-center justify-center py-3.5 px-6 rounded-2xl bg-[#01AC51] text-white font-bold text-lg md:text-xl shadow-lg transform transition-all duration-300 hover:bg-[#019245] hover:scale-[1.02] hover:shadow-xl active:scale-[0.98]"
                >
                  Learn More
                </a>
              </div>
