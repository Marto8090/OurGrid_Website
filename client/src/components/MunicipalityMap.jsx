...
const hotspots = [
  // RED – High congestion
  {
    ...
    lng: 5.45340,
    severity: 3,
    label: "Strijp-S – High density redevelopment",
  },
  {
    lat: 51.44164,
    lng: 5.46972,
    severity: 3,
    label: "Centrum / Station – Mobility + commercial load",
  },
  {
    lat: 51.46040,
    lng: 5.47670,
    severity: 3,
    label: "Woensel-Zuid – Dense residential demand",
  },
  {
    lat: 51.42460,
    lng: 5.49140,
    severity: 3,
    label: "Stratum – Older grid under heavy load",
  },
  ...
  // YELLOW – Mid congestion
  {
    ...
    lng: 5.50850,
    severity: 2,
    label: "Tongelre – Mixed industrial/residential",
  },
  {
    lat: 51.44680,
    lng: 5.39280,
    severity: 2,
    label: "Meerhoven – High EV demand",
  },
  {
    lat: 51.42650,
    lng: 5.45510,
    severity: 2,
    label: "Gestel – Strong evening peak",
  },
  {
    lat: 51.47400,
    lng: 5.49370,
    severity: 2,
    label: "Woensel-Noord – Developing residential zones",
  },
  ...
  // GREEN – Low/No congestion
  {
    ...
    lng: 5.45040,
    severity: 1,
    label: "High Tech Campus – Modern grid infrastructure",
  },
  {
    lat: 51.45930,
    lng: 5.37760,
    severity: 1,
    label: "Acht / Airport – Balanced industrial demand",
  },
  {
    lat: 51.47500,
    lng: 5.54890,
    severity: 1,
    label: "Nuenen border – Low residential stress",
  },
  {
    lat: 51.42330,
    lng: 5.55990,
    severity: 1,
    label: "Geldrop border – Stable suburban load",
  },
  {
    lat: 51.42080,
    lng: 5.39200,
    severity: 1,
    label: "Veldhoven-Zuid – Healthy distribution",
  },
];
